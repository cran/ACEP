...
#' \item{rp_procesada}{es un data frame con indicadores de conflictividad basados en los datos de la Revista Puerto}
#' \item{lc_mdp}{es una url para la descarga del corpus de notas de La Capital}
#' \item{rp_mdp}{es una url para la descarga del corpus de notas de la Revista Puerto}
#' \item{ed_neco}{es una url para la descarga del corpus de notas de Ecos Diarios}
#' \item{ln_bb}{es una url para la descarga del corpus de notas de La Nueva}
#' \item{ln_arg}{es una url para la descarga del corpus de notas de La Nación}
#'}
#' @docType data
