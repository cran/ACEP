...
#' devuelve una tabla con tres columnas nuevas: número de palabras,
#' número de menciones del diccionario, índice de intensidad.
...
#' @return Si todas las entradas son correctas, la salida será una
